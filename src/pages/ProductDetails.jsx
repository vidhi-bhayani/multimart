...
import "../styles/product-detils.css";
          ...
          <Row>
            ...
            <Col lg="6">
              <div className="product__detail">
                <h2>{productName}</h2>
                <div className="product__rating d-flex align-items-center gap-5 color: coral mb-3">
                  <div>
                    <span >
                    ...
                    <ul>
                      ...
                      <div className="review__form">
                        ...
                        <form action="" onSubmit={submitHandler}>
                          ...
                          <div className="form__group gap-5 rating__group">
